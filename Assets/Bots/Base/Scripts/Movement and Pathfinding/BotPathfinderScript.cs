...
public class BotPathfinderScript : NetworkedBehaviour
{
    ...
    void Start()
    {
        ...
        bot.entityMovementScript.apply = false;//Make the bot not able to move until we find a valid path
    ...
    {   
        ...
        bot.botMovementScript.MoveToPosition(currentDestinationPoint);//Move to the correct position
    }
    ...
    public void SetDestinationPoints(List<Vector3> points) 
    {
        ...
        bot.entityMovementScript.apply = true;//Let the bot move since we have a valid path
    }
